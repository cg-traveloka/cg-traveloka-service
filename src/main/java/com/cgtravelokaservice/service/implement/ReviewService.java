...
public class ReviewService implements IReviewService {
    ...
    public HotelReview saveReview(ReviewRequestDTO requestDTO) {
        ...
        List<HotelReview> reviews = hotelReviewRepo.findByHotelId(requestDTO.getContractId());
        if (reviews.isEmpty()) {
            return null;
        }
        ...
        Double averageRatingPoints = calculateAverageRatingPoints(contract.getRoom().getHotel().getId());
